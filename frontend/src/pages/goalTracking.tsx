...
const GoalTracking = () => {
  ...
  return (
    <div className="h-screen bg-sky-950">
      <div className="max-w-2xl mx-auto bg-sky-950">
        ...
        >
          <label className="flex flex-col">
            <span className="text-white font-bold mb-2">Title:</span>
            <input
              type="text"
              name="title"
              required
          ...
          <label className="flex flex-col">
            <span className="text-white font-bold mb-2">Description:</span>
            <input
              type="text"
              name="description"
              required
          ...
          <label className="flex flex-col">
            <span className="text-white font-bold mb-2">Target:</span>
            <input
              type="number"
              name="target"
              required
