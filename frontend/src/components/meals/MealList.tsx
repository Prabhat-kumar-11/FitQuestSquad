...
import { getMeal } from "../../redux/meals/action";
const breakfastData = {
  protein: 97,
  fats: 117,
  carbs: 272,
...
export const MealsList = () => {
  ...
  const mealsData = useSelector((store: any) => {
  ...
  return (
    <div className="dark:bg-gray-800  h-screen">
      <div className="p-4 dark:bg-gray-800   text-white mx-auto my-auto">
        ...
        {showmeals ? (
          <div
            className="bg-[#334155] mx-auto mb-5  rounded mt-10 p-4 w-3/5
          "
          >
            ...
            <div>
              <table className="mx-auto w-3/5">
                ...
                <tbody>
                  {mealsData?.map((el: any, index: number) => (
                    <tr>
